...
public extension Amazing.Image {
    
    convenience init<AmazingType: Amazing>(icon: AmazingType, size: CGSize, color: Amazing.Color = .black, backgroundColor: Amazing.Color = .clear) {
    ...
    convenience init<AmazingType:Amazing>(icon: AmazingType, size: CGFloat, color: Amazing.Color = .black, backgroundColor: Amazing.Color = .clear) {
    ...
    convenience init<AmazingType:Amazing>(topIcon: AmazingType, bottomIcon: AmazingType, topIconColor: Amazing.Color = .black, bottomIconColor: Amazing.Color = .black, backgroundColor: Amazing.Color = .clear, size: CGSize? = nil) {
